...
public class SearchResultMoreController extends AbstractController {
	...
	private static final long serialVersionUID = 7611934123004075536L;
	
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		SearchForm searchForm = createSearchForm(req);
		List<Product> products = getProductService().listProductsBySearchForm(searchForm, getPage(req), Constants.MAX_PRODUCT_PER_HTML_PAGE);

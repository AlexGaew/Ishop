...
public class ServiceManager {
	...
	private BasicDataSource createDataSourse() {
	...
	//	dataSource.setInitialSize(Integer.parseInt(getApplicationProperty("3")));
	//	dataSource.setMaxTotal(Integer.parseInt(getApplicationProperty("5")));
		return dataSource;
	}
